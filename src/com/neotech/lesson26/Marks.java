...
public abstract class Marks {
	 ...
	 * student A and by student B. Create a class 'Marks' with an abstract method
	 * 'getAverage' that will be returning the average of marks. Provide
	 * implementation of the abstract method in classes 'StudentA' and 'StudentB'.
